...
class LLMFarmPydantic:
    def __init__(self, model="gpt-4o-mini"):
        ...
        # Base URL - clean without /chat/completions and without api-version
        base_url = "https://aoai-farm.bosch-temp.com/api/openai/deployments/askbosch-prod-farm-openai-gpt-4o-mini-2024-07-18"
        
        self.logger.info(f"Base URL: {base_url}")
        
        # Create AsyncOpenAI client with extra_query parameter
        try:
            client = AsyncOpenAI(
                ...
                # Add the api-version as extra query parameter
                default_query={"api-version": "2024-08-01-preview"}
            )
            self.logger.info("AsyncOpenAI client created successfully with extra query parameters")
...
if __name__ == "__main__":
    print("=== LLM Farm PydanticAI Debug Test (DEFAULT_QUERY VERSION) ===")
    print("This version uses default_query parameter to add api-version")
