...
class LLMFarmPydantic:
    def __init__(self, model="gpt-4o-mini"):
        ...
        # CORRECT SOLUTION: Base URL without /chat/completions but WITH api-version
        # OpenAI client will add /chat/completions to this base URL
        # Final URL will be: base_url + /chat/completions
        ...
        self.logger.info("OpenAI client will append '/chat/completions' to this base URL")
...
if __name__ == "__main__":
    print("=== LLM Farm PydanticAI Debug Test (FINAL CORRECT VERSION) ===")
    print("Expected final URL: https://aoai-farm.bosch-temp.com/api/openai/deployments/askbosch-prod-farm-openai-gpt-4o-mini-2024-07-18?api-version=2024-08-01-preview/chat/completions")
